    ...
    _createClass(Modal, [{
      ...
      value: function _openModal(modal) {
        ...
        fastdom.mutate(function () {
          ...
          document.documentElement.classList.add('no-scroll');
		  if (_this15.activeModal.classList.contains('Search')) {
  ...
  var Search = function () {
    ...
    _createClass(Search, [{
      ...
      value: function _onInput(event) {
        ...
        var queries = [fetch('/search?view=ajax&q=' + encodeURIComponent(this.lastInputValue) + '*&type=product&limit=100', queryOptions)];
