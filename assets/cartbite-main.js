if(!window.initVar){
  window.initVar = {
    ...
    meta: {},
    vapidKey: "BDtuZnIqjZG-JZd6ZCtFYbBhwCn4qYQpQfcERZ9LValGK1b_NCJvYJsfJ1msZMXl0QUq6px5PrqH9zzZRkev07A",
    clientId: "QJQF8Y7KG4N1BH9ZS6MJGTIC",
    pushOptInSetting: {"delay":86400,"message":{"body":"We will notify you about new products and exclusive promotions","title":"Never miss a sale","buttons":[{"label":"Later","order":1},{"label":"Allow","order":2}],"iconUrl":"https://cdn.shopify.com/s/files/1/2869/2938/t/16/assets/grow-F8G17WMWFLUR6U8UU9ZTRQNX.png"},"isEnabled":false,"showModal":true,"initialDelay":10},
    subscriberId: '',
    stockFulFilledPushCampaign: {
      isActive: true,
      uniqueId: 'ZE2Z82DIP1EX5GQFCRYQZ62I'
    },
    stockFulFilledEmailCampaign: {
      isActive: true,
      uniqueId: 'UDVR8LQFKE4ZITKQLSNAVDWF'
    },
    stockFulFilledSmsCampaign: {
      isActive: true,
      uniqueId: 'LAQISA5RFMM5B8T3WVAQ2UJ2'
    },
    priceDropPushCampaign: {
      isActive: false,
      uniqueId: 'U36RK7THEK8PTDCPK8BXU7XV',
    },
    priceDropEmailCampaign: {
      isActive: false,
      uniqueId: '3BYWSC5KI6KN2JWNIMPGWIIQ',
    },
    priceDropSmsCampaign: {
      isActive: true,
      uniqueId: 'ALJJ7L24JJQQAKJ4DRAD14E6',
    },
    stockWidget: {
